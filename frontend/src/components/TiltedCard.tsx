    ...
    return (
        ...
        >
            ...
            >
                ...
                {displayOverlayContent && overlayContent && <motion.div className="absolute top-0 left-0 z-[2] will-change-transform [transform:translateZ(30px)]">sdfsdfsdf</motion.div>}
            </motion.div>
        </figure>
    )
}
